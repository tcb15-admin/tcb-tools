...
| 文書 | 版 | 場所 |
|------|-----|------|
| TCB-OPS-001 GitHub 運用手順書 | 1.11 | [boys15/docs/](./boys15/docs/) |
...
- **割り振り方法の選択** … 前回基準モードで「公平に分散」（既定）／「前回のまま維持」を選択（v1.9.2〜）
...
- **前回の結果を元に調整** … きょうの割振りカードまたは履歴詳細から開始。欠席・当番・班替えの差分だけ自動調整（v1.7.0〜）
