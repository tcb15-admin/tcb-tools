#!/usr/bin/env node
/**
 * Markdown + images → PDF（印刷用）
 * 実行: node boys16/docs/scripts/build-pdf.mjs
 */
import fs from 'fs';
...
const OUT = path.join(DOCS, 'TCB-MAN-016_道具割り振りツール_操作マニュアル_v1.5.pdf');
...
<head>
<meta charset="utf-8"/>
<title>16期 道具割り振りツール 操作マニュアル v1.5</title>
<style>
...
<body>
<div class="url-box">
<strong>16期道具マネージャー向け — 最新マニュアル（公式参照URL）</strong>
