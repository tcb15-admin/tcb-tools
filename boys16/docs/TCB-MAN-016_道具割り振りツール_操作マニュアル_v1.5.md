...
3. 画面上部に **STEP 1｜2｜3** と、右上に **マスタ・履歴・v1.6.4** が表示されればOKです。
...
**文書末尾** — 版 1.6（2026-05-22、ツール v1.6.4）。仕様の詳細はリポジトリ内 `boys15/docs/TCB-SPEC-001` 等を参照。本書は16期道具マネージャー向けの操作手順に特化しています。
