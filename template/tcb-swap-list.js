...
(function (global) {
  ...
  function renderHtml(report, opts) {
    ...
    html += '<div class="tcb-swap-list-hd">入れ替えリスト（活動前の受け渡し）</div>';
    html += '<p class="tcb-swap-list-lead">次回活動日までに、下記の保護者間で道具を受け渡してください（試合組⇔練習組の入れ替え含む）。当日の通常割振り（持ち帰り担当の決定）とは別の案内です。</p>';
