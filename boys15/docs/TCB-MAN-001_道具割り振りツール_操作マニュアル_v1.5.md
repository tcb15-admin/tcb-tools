...
| 対象 | 15期 道具マネージャー |
| 作成日 | 2026年5月 |
| 最終更新 | 2026年7月5日（ツール v1.7.3・フロー図レイアウト改善） |
...
**文書末尾** — 版 1.11（2026-07-05、ツール v1.7.3・フロー図レイアウト改善）。仕様の詳細はリポジトリ内 `boys15/docs/TCB-SPEC-001` 等を参照。本書は15期道具マネージャー向けの操作手順に特化しています。
